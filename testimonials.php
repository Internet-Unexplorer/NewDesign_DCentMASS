...
<span class="para-heading" style="margin:16px;"><center><b>STUDENTS</b></center></span>
<div class="row">
    <div class="col-md-3" >
      <div style="box-shadow:none;border:none;" class="card" >
    <img class="card-img-top" src="images/jack.jpg" alt="Card image" >
    <div class="card-body">
      <center><h4 class="card-title"><b>John Doe</b></h4>
      <p class="card-text">Some example text some example text. John Doe is an architect and engineer</p>
      <div>
      <a href="#" style="text-decoration:none;">
    <i class="fa fa-2x fa-linkedin-square"></i>&nbsp&nbsp&nbsp&nbsp</a>
    <a href="#" style="text-decoration:none;">
    <i class="fa fa-2x fa-facebook-f"></i>&nbsp&nbsp&nbsp&nbsp</a>
    <a href="#" style="text-decoration:none;">
    <i class="fa fa-2x fa-apple"></i>&nbsp&nbsp&nbsp&nbsp&nbsp
   </a> </div>
    </div>
  </div>
    </div>
...
<span class="para-heading" style="margin:16px;"><center><b>TRAINEES</b></center></span>
<div class="row">
    <div class="col-md-3" >
      <div style="box-shadow:none;border:none;" class="card" >
