...
<div class="row" >
    <div class="col-md-6" style="padding-left:0px;"><img src="images/interview-services.jpg" style="width:100%;height:100%;" class="img-fluid"></div>
    <div class="col-md-6" style="padding:0px;">Hudson RPO services allows both large and mid-sized companies to attain a world-class recruitment function. Our recruitment process outsourcing team works seamlessly within your HR management structure. A comprehensive HR solution can manage the entire recruitment lifecycle for your professional-level staff, or you can selectively use our expertise where your business needs it most.</div>
</div>

<div class="row">
<span class="sub-heading"><center>WHY USE RECRUITMENT PROCESS OUTSOURCING SERVICES?</center></span>
  <div class="col-md-6" style="padding-left:0px;">fjakljfka</div>
